...
#define JSOP_DEFSHARP_LENGTH             5
#define JSOP_USESHARP_LENGTH             5
...
#define JSOP_INCGNAME_LENGTH             3
#define JSOP_DECGNAME_LENGTH             3
#define JSOP_GNAMEINC_LENGTH             3
#define JSOP_GNAMEDEC_LENGTH             3
...
#define JSOP_LEAVEBLOCK_LENGTH           5
#define JSOP_IFPRIMTOP_LENGTH            3
#define JSOP_PRIMTOP_LENGTH              2
...
#define JSOP_LEAVEBLOCKEXPR_LENGTH       5
...
#define JSOP_LAMBDA_FC_LENGTH            3
#define JSOP_OBJTOP_LENGTH               3
#define JSOP_TRACE_LENGTH                3
#define JSOP_GETUPVAR_DBG_LENGTH         3
#define JSOP_CALLUPVAR_DBG_LENGTH        3
#define JSOP_DEFFUN_DBGFC_LENGTH         3
#define JSOP_DEFLOCALFUN_DBGFC_LENGTH    5
#define JSOP_LAMBDA_DBGFC_LENGTH         3
#define JSOP_SETMETHOD_LENGTH            3
#define JSOP_INITMETHOD_LENGTH           3
#define JSOP_UNBRAND_LENGTH              1
#define JSOP_UNBRANDTHIS_LENGTH          1
#define JSOP_SHARPINIT_LENGTH            3
#define JSOP_GETGLOBAL_LENGTH            3
#define JSOP_SETGLOBAL_LENGTH            3
#define JSOP_INCGLOBAL_LENGTH            3
#define JSOP_DECGLOBAL_LENGTH            3
#define JSOP_GLOBALINC_LENGTH            3
#define JSOP_GLOBALDEC_LENGTH            3
#define JSOP_CALLGLOBAL_LENGTH           3
